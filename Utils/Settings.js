...
function SetSettings(acceptNormalVote, acceptAdminVote, acceptAmount, denyNormalVote, denyAdminVote, denyAmount) {
...
async function CalculateSettingsPercentages() {
...
checkSuggestionVoting = null;
function SetCheckSuggestionVoting(func){
    checkSuggestionVoting = func
}

module.exports = {
    WriteSettingsFile, LoadSettings,
    SetSettings,
    CalculateSettingsPercentages,
    GetSettings,

    SetCheckSuggestionVoting
};