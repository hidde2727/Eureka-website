...
async function GetAllInspirationVersionsOfID(inspirationID) {
...
// + ======================================================================== +
async function CreateInspirationVoteOrUpdate(value, adminVote, userID, inspirationUUID) {
    await ExecutePreparedStatement(
...
// + ======================================================================== +
async function CreateProjectVoteOrUpdate(value, adminVote, userID, projectUUID) {
    await ExecutePreparedStatement(
...
// + ======================================================================== +
async function GetAllSuggestionWithVotes(userID) {
    var results = await ExecutePreparedStatement(`
    SELECT
        i.uuid AS uuid,
        i.name AS name,
...
async function GetAllOpenSuggestions() {
...
module.exports = {
    ...
    CreateUser, DoesUsernameExist, DeleteUser, DeleteUserWithName, SetUserPermissions, SetUserUsername, SetUserPassword, GetUser, GetUserByName, GetAllUsers, GetAmountUsers, GetAmountAdmins,
    CreateSession, DoesSessionIDExist, DeleteSession, DeleteInvalidSessions, GetSession,
    CreateInspiration, DoesInspirationExist, SetInspirationAsActive, GetInspiration, GetAllActiveInspirationWithLabels, GetAllActiveInspiration, GetAllInspirationVersionsOfID,
    ...
    CreateProject, SetProjectAsActive, GetProject, GetAllActiveProjects, GetAllProjectVersionsOfID, IsValidProject,
    CreateInspirationVote: CreateInspirationVoteOrUpdate, GetInspirationVotes, AcceptInspiration, DenyInspiration,
    CreateProjectVote: CreateProjectVoteOrUpdate, GetProjectVotes, AcceptProject, DenyProject,
    GetAllSuggestionWithVotes, GetAllOpenSuggestions,
