...
async function VoteProject(req, uuid, value, isAdmin) {
...
async function CheckProjectVotes(uuid) {
...
async function VoteInspiration(req, uuid, value, isAdmin) {

}

async function CheckInspirationVotes(uuid) {
